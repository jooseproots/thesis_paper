...
Def. budget per capita & $0.3635, p=0.0003$ & - \\
Def. budget \% GDP & $-0.0984, p=0.0898$ & $0.0918, p=0.0442$ \\
GDP per capita \% change & $-0.0032, p=0.4352$ & $-0.0073, p=0.0989$ \\
Def. budget per capita \% change & $0.0007, p=0.5899$ & - \\
Def. budget \% GDP \% change & $-0.0019, p=0.1055$ & $-0.0011, p=0.1599$ \\
\addlinespace
...
Def. budget \% GDP & $0.0918, p=0.0442$ & $0.1058, p=0.0521$ & $0.0915, p=0.0438$ \\
GDP per capita \% change & $-0.0073, p=0.0989$ & $-0.0072, p=0.1098$ & $-0.0072, p=0.1044$ \\
Def. budget \% GDP \% change & $-0.0011, p=0.1599$ & $-0.0017, p=0.0321$ & $-0.0011, p=0.1592$ \\
...
Based on these results, Model C with full data, including interpolated and filled values, 
and a dummy for flagging imputed values was chosen
...
Furthermore, Model B, which excluded imputed data, was overall statistically insignificant,
again supporting the choice of with the full sample and appropriate controls.
