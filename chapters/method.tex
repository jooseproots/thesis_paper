...
Data types were then adjusted so that numerical values were presented in a consistent format. (neccessary???)
...
The active armed forces per capita column was created using military and population data
and additional 
columns for annual changes in GDP per capita, defence spending per capita  
...
be conducted to analyze the effect of imputation more in depth.
